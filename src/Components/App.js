        ...
        <>
            ...
            >
                ...
                <Col className="gutter-row description-juega" span={12}>
                    <Meta title="JUEGA!"
                          description="Diviérte y conoce toda lo maravilloso que ofrece ECUADOR!, Diviérte y conoce toda lo maravilloso que ofrece ECUADOR!. Diviérte y conoce toda lo maravilloso que ofrece ECUADOR!"/>
                    <Button type="primary" className="button-conoce-juega"> IR A JUGAR </Button>
                </Col>

                <Col className="gutter-row description" span={12}>
                    <Meta title="CONOCE!"
                          description="Viaja por Ecuador a través de sus regiones y aprende!, Viaja por Ecuador a través de sus regiones y aprende!. Viaja por Ecuador a través de sus regiones y aprende!"/>
