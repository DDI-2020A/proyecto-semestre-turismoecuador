...
const ForumInformation = ({province, nameProvince}) => {
            ...
            return (
              <>
                ...
                <Modal
                  ...
                  className = 'titleOriente'
                  key = {'2'}
                >
                  <div key = {'3'}>
                        <Card key = {'4'} className= 'titleOriente' bordered={true} align="left">
                        {
    ...
    useEffect( () => {
        const getProvince = async() => {
            await FIREBASE.db.ref(`regions/Oriente/provinces/${province}`).on('value', (snapshot) => {
                let data = [];
        ...
        const getComments = async() => {
            FIREBASE.db.ref( `regions/Oriente/provinces/${province}/comments` ).on( 'value', ( snapshot ) => {
              const dataComment = [];
        ...
        return () => {
            ...
            FIREBASE.db.ref(`regions/Oriente/provinces/${province}`).off();
            FIREBASE.db.ref(`regions/Oriente/provinces/${province}/comments`).off();
        };
      }, []);
        ...
        const addComment = async ( values ) => {
            ...
            await FIREBASE.db.ref(`regions/Oriente/provinces/${province}/comments`).push({
                    ...
                    ?
                        <>
                            <Row key = {'15'} gutter={16} justify="end">
                                ...
                                <Col key = {'18'} span = {24}>
                                    <h3 key = {'19'} className = "titleOriente">{nameProvince}</h3>
                                </Col>
                            </Row>
