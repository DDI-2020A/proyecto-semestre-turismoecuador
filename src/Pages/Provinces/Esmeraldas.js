                    ...
                    dataSource.map((region, index) => (
                        region.key === 'Costa' || region.provinces === 'esmeraldas'?
                            <>
                                ...
                                <h3 className = "titleCosta">Esmeraldas</h3>
                                <Carousel autoplay >
                                    <div>
                                        <Card title={ region.provinces.esmeraldas.images.image1.namePlace } bordered={false} style={ StyleCardPrincipal }>
                                            <img className="contentStyle" alt="exampleImage" key = {index} src={ region.provinces.esmeraldas.images.image1.photoPlace }/>
                                        </Card>
                                    </div>
                                    <div>
                                        <Card title={ region.provinces.esmeraldas.images.image2.namePlace } bordered={false} style={ StyleCardPrincipal }>
                                            <img className="contentStyle" alt="exampleImage" key = {index} src={ region.provinces.esmeraldas.images.image2.photoPlace }/>
                                        </Card>
                                    </div>
                                    <div>
                                        <Card title={ region.provinces.esmeraldas.images.image3.namePlace } bordered={false} style={ StyleCardPrincipal }>
                                            <img className="contentStyle" alt="exampleImage" key = {index} src={ region.provinces.esmeraldas.images.image3.photoPlace }/>
                                        </Card>
                                    </div>
                                    <div>
                                        <Card title={ region.provinces.esmeraldas.images.image4.namePlace } bordered={false} style={ StyleCardPrincipal }>
